...
# Evaluate Per-Task Gate Zone-Specialized MoE technique classification (+ optional RWC)
# 3 independent gates: tonal, articulation, legato
...
CHECKPOINT="${1:-${WORKSPACE}/checkpoints/main_contrast/vioptt_viotech_moe_zone_pertask_v0.1/Regress_onset_offset_frame_velocity_CRNN/loss_type=regress_onset_offset_frame_velocity_bce/augmentation=aug/max_note_shift=2/batch_size=4/10000_iterations.pth}"
...
echo "============================================"
echo "  Per-Task Gate Zone MoE Evaluation"
echo "============================================"
...
python3 pytorch/evaluate_moe_zone_pertask.py \
